...
* Installs Jekyll static site generator and tests a site can be compiled

The *Local Testing* environment tests multiple scenarios:

1. Installs Jekyll static site generator and tests a site can be compiled
...
to bring up a local testing environment
2. `$ cd jekyll3/tests/provisioning/site-testing-local`
3. `$ vagrant up`
4. `$ cd ..`
...
1. `$ cd jekyll3/tests/provisioning`
...
Results for these tests can be found [here](https://semaphoreci.com/bas-ansible-roles-collection/jekyll3).
