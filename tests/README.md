...
* Installs Jekyll and ensures it can be used successfully

Multiple scenarios are tested *manually*:

1. `test-bare` - Installs Jekyll and ensures it can be used successfully
...
[here](https://semaphoreci.com/antarctica/ansible-jekyll3).
...
| ----------------------------- | ----------------- | ----------------------------------- | --------------------------- |
| barc-jekyll3-test-ubuntu-bare | *computed value*  | `barc-jekyll3-test-ubuntu-bare.v.m` | The VM's private IP address |
| barc-jekyll3-test-centos-bare | *computed value*  | `barc-jekyll3-test-centos-bare.v.m` | The VM's private IP address |
